...
import com.example.codal.databinding.ActivityHackaThonListBinding
...
class HackaThonList : AppCompatActivity(),adapterOnClick {
    lateinit var binding: ActivityHackaThonListBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityHackaThonListBinding.inflate(layoutInflater)
        setContentView(binding.root)
        supportActionBar?.hide()
        db = Firebase.firestore
        collect = db.collection("userMods")
        collect
            .orderBy("numHacks", Query.Direction.DESCENDING)
            .get()
