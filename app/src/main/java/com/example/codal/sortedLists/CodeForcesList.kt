...
class CodeForcesList : AppCompatActivity(),adapterOnClick {

    lateinit var binding: ActivityCodeForcesListBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCodeForcesListBinding.inflate(layoutInflater)
        setContentView(binding.root)
        supportActionBar?.hide()
        db = Firebase.firestore
        collect = db.collection("userMods")
        collect
            .orderBy("cforces_rating", Query.Direction.DESCENDING)
            .get()
            .addOnSuccessListener { result ->
                ...
                val recView = binding.cforcesList
